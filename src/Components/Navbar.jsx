...
function Navbar() {
  ...
  return (
    ...
    <nav className='flex px-2 py-3 justify-between items-center w-[97.5%] mx-auto rounded-xl backdrop-blur-md bg-[#ffffff30]'>
        ...
        <div className={`md:static absolute md:min-h-fit min-h-[40vh] w-full rounded-xl bg-[#ffffff30] md:bg-transparent left-0 md:w-auto md:z-auto z-[-10] flex items-center px-5 transition-all ease-in ${open ? 'top-[100%]': 'top-[-350%]'}`}>
