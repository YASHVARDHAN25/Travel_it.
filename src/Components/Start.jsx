...
function Start() {
      ...
      useEffect(() => {
        ...
        gsap.to('.container', {opacity: 0, delay: 5.8})
      }, []);
      return (
        <>
      <div ref={containerRef} className='container' style={{width: '100%', overflow: 'hidden', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#0F0E0F'}}>
